...
@fwdprop_test_factory(mygrad_func=sqrt, true_func=np.sqrt, xbnds=(0, 100))
def test_sqrt_fwd(): pass


@backprop_test_factory(mygrad_func=sqrt, true_func=np.sqrt, xbnds=(0, 100), no_go=(0,), atol=1e-3)
